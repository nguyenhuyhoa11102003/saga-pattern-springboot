package com.demo.orderservice.infrastruture.message;

import com.demo.orderservice.domain.PlacedOrderEvent;
import com.demo.orderservice.domain.port.EventHandlerPort;
import com.demo.orderservice.domain.port.OrderUseCasePort;
import com.demo.orderservice.infrastruture.message.log.MessageLog;
import com.demo.orderservice.infrastruture.message.log.MessageLogRepository;
